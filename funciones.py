...
def get_recommendation(item_name: str):
    ...
    item_id_to_name = df_final.drop_duplicates('item_id').set_index('item_id')['item_name'].to_dict()
    similar_items = [item_id_to_name[i] for i in indices_similares[item_name]]
    del df_final
